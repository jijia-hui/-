...
- **测试**：`04_tests/unit/test_serializers.py`（UNIT-TC01）、`04_tests/integration/test_uc01_registration.py`（INT-TC01，9 例）、E2E-TC01
...
- **测试**：INT-TC02 `04_tests/integration/test_uc02_login.py`、E2E-TC02
...
- **测试**：UNIT-TC03 `04_tests/unit/test_serializers.py`、INT-TC03 `04_tests/integration/test_uc03_course_browse.py`、E2E-TC03
...
- **测试**：UNIT-TC04 `04_tests/unit/test_models.py`、INT-TC04 `04_tests/integration/test_uc04_enroll.py`（选课/退课/教师被拒）、E2E-TC04
...
- **测试**：INT-TC05 `04_tests/integration/test_uc05_create_course.py`、E2E-TC05
...
- **测试**：UNIT-TC06 `04_tests/unit/test_permissions.py`、INT-TC06 `04_tests/integration/test_uc06_manage_course.py`（编辑/删除/越权）、E2E-TC06
...
- **测试**：INT-TC07 `04_tests/integration/test_uc07_manage_assignment.py`（含参考文档上传）、E2E-TC07
...
- **测试**：INT-TC08 `04_tests/integration/test_uc08_assignment_detail.py`、E2E-TC08
...
- **测试**：UNIT-TC09 `04_tests/unit/test_models.py`（is_expired）、INT-TC09 `04_tests/integration/test_uc09_submission.py`（4+5 例）、E2E-TC09
...
- **测试**：INT-TC10 `04_tests/integration/test_uc10_my_submissions.py`（防篡改）、E2E-TC10
...
- **测试**：INT-TC11 `04_tests/integration/test_uc11_teacher_review.py`、E2E-TC11
...
- **测试**：UNIT-TC12 `04_tests/unit/test_models.py`、INT-TC12 `04_tests/integration/test_uc12_grade.py`（正常/边界/学生 403/非授课教师/越界）、E2E-TC12
...
- **测试**：INT-TC13 `04_tests/integration/test_uc13_profile.py`、E2E-TC13
...
- **测试**：INT-TC14 `04_tests/integration/test_uc14_admin.py`（管理页访问 + 权限隔离）、E2E-TC14（真实登录 + 4 管理页）
...
| 全量自动化测试 | ✅ 132/132 | 单元 39 + 集成 93：`PYTHONPATH=web_backend python web_backend/manage.py test 04_tests/unit 04_tests/integration` |
| 端到端测试（逐用例走 API） | ✅ 47/47 | `04_tests/e2e/run_e2e.py`（E2E-TC01~14，含异常流程与管理员后台；第 1 天冒烟 32/32 保留） |
